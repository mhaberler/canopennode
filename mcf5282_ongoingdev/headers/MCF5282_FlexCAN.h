...
#define MCF_FlexCAN_RXGMASK_MID_EXT(x)       (((x)&0x3FFFF)<<0x1)
#define MCF_FlexCAN_RXGMASK_MID(x)           (((x)&0x7FF)<<0x15)

/* Bit definitions and macros for MCF_FlexCAN_RX14MASK */
#define MCF_FlexCAN_RX14MASK_MID_EXT(x)      (((x)&0x3FFFF)<<0x1)
#define MCF_FlexCAN_RX14MASK_MID(x)          (((x)&0x7FF)<<0x15)

/* Bit definitions and macros for MCF_FlexCAN_RX15MASK */
#define MCF_FlexCAN_RX15MASK_MID_EXT(x)      (((x)&0x3FFFF)<<0x1)
#define MCF_FlexCAN_RX15MASK_MID(x)          (((x)&0x7FF)<<0x15)
