...
/*******************************************************************************
   ...
   Variables:
      timestamp			- 8 bits timestamp, see MCF5282 documentation
      code				- Message Buffer code. see MCF52825 documentation
      DLC               - Data length code
      ident             - Standard Identifier - 11bits
      RTR               - Remote Transmission Request bit.
      timestamp16		- See MCF5282 documentation
      data              - 8 data bytes.
*******************************************************************************/
typedef struct{
   unsigned       timestamp		:8;
   unsigned       code   		:4;
   unsigned       DLC   		:4;
   unsigned       sid      		:11;
   unsigned       RTR      		:1;
   unsigned                		:4;
   unsigned		  timestamp16 	:16;
   UNSIGNED8      data[8];
}CO_CANrxMsg_t; 
...
/*******************************************************************************
   ...
   Variables:
      DLC				- Data Length Code
      ident				- 11-bit standard identifier as aligned in CAN module. Include RTR.    
...
/*******************************************************************************
   ...
   Parameters:
      ...
      CANbitRate        - CAN bit rate. Valid values are (in kbps): 125, 1000. 
...
/*******************************************************************************
   ...
   PIC32MX specifics: Normal copy is used in all cases. All variables
   are in RAM. (EEPROM and ROM variables may be backuped into external eeprom chip.)
   CANopen and PIC32MX uses Little endian, so no byte inversion is implemented.
