...
// TX data *******************************************************************************************
	...
	switch (SDO_C->state){
		...
		case SDO_STATE_BLOCKDOWNLOAD_CRC:{
			...
			SDO_C->CANtxBuff->data[1] = (UNSIGNED8) tmp16;
			SDO_C->CANtxBuff->data[2] = (UNSIGNED8) (tmp16>>8);
...
******************************************************************************/
INTEGER8 CO_SDOclientUploadInitiate(
		CO_SDOclient_t				*SDO_C,
		UNSIGNED16					index,
		UNSIGNED8					subIndex,
		UNSIGNED8					*dataRx,
