...
/*******************************************************************************
   ...
   Variables:
      ...
      subIndex    - Subindex of object in Object dictionary (informative, must
                    NOT be changed).
      writing     - True, if SDO download is in progress, false if SDO upload
                    is in progress.
...
/*******************************************************************************
   ...
   CO_SDO_BUFFER_SIZE   - Value can be in range from 4 to 889 bytes.
*******************************************************************************/
...
typedef struct{
   ...
   UNSIGNED8                     CANrxData[8];
   UNSIGNED8                     CANrxNew;

   CO_CANmodule_t               *CANdevTx;
   CO_CANtxArray_t              *CANtxBuff;

   UNSIGNED8      block_state;
   UNSIGNED8       block_seqno;
   UNSIGNED8      block_blksize;
   UNSIGNED8      block_blksizeMAX;

   UNSIGNED16                    bufferOffsetACK;//TODO
   UNSIGNED16      block_bufferOffset; // offset of first data in block
   //UNSIGNED8      block_blkcount;

   UNSIGNED32       block_dataSize;

   UNSIGNED8      block_noData;

   UNSIGNED8      block_clientCRC;
   UNSIGNED16      block_serverCRC;
   UNSIGNED8       block_pst;
