...
/*******************************************************************************
   ...
   For dsPIC33F and PIC24H with Microchip C30:
...
/*******************************************************************************
   ...
   ADDR_DMA0      - Starting address of DMA 0 configuration registers.
   ...            - ...
   ADDR_DMA7      - Starting address of DMA 7 configuration registers.
 *******************************************************************************/
...
/*******************************************************************************
   ...
   Variables:
      scale    - (1 or 2) Scales FCY clock - dsPIC33F and PIC24H specific.
...
/*******************************************************************************
   ...
   Variables:
      ...
      useCANrxFilters   - Value different than zero indicates, that CAN module
                          ...
                          by software. dsPIC33F devices have 16 CAN rx filters.
...
/*******************************************************************************
   ...
   Parameters:
      ...
      DMArxBaseAddress  - Base address for registers for DMA reception. See <Peripheral addresses>.
      DMAtxBaseAddress  - Base address for registers for DMA transmission. See <Peripheral addresses>.
      CANmsgBuff        - Pointer to CAN message buffer of type <CANMsgBuff> defined in DMA RAM.
      CANmsgBuffSize    - Size of above buffer.
      CANmsgBuffDMAoffset - DMA offset of the CANmsgBuff.
...
/*******************************************************************************
   ...
   dsPIC33F and PIC24H specifics: Normal copy is used in all cases. All variables
   are in RAM. (EEPROM and ROM variables may be backuped into external eeprom chip.)
   CANopen and dsPIC33F uses Little endian, so no byte inversion is implemented.
   With Big endianes, bytes must be inverted if CO_ODA_MB_VALUE bit is true.
